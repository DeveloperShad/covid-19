...
function fetchNews(page) {
	...
	fetch(`https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/news/get-vaccine-news/${page || 0}`, {
		"method": "GET",
		"headers": {
...
function showData(arr,display,pagination) {
	...
	arr.forEach(element => {
		...
		let { urlToImage, title, content, link, pubDate, reference } = element
